...
| 章 | 本章只解决什么 | 学完可以做什么 |
|---|---|---|
| [4. 让模型回复逐字显示](../04-streaming-text/) | 把文本分片立即交给界面 | 用户无需等待完整回复 |
...
- 已收录：本篇总览、[第 1 章：定义一次模型调用](../01-unified-contract/)、[第 2 章：选择并调用不同模型服务](../02-provider-routing/)、[第 3 章：接入阿里云百炼](../03-bailian-provider/)、[第 4 章：让模型回复逐字显示](../04-streaming-text/)
- 第 5～10 章尚未收录，待更新，后续按章节顺序更新。
